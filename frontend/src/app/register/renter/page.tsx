        ...
        <div className="flex items-center justify-center min-h-screen relative bg-muted/20">
            <Card className="w-[400px] border-primary/20 shadow-md">
                <CardHeader className="bg-primary/5 rounded-t-lg">
                     <CardTitle className="text-primary">Partner with FieldMax</CardTitle>
                    <CardDescription>
                        Create a Venue Owner account to manage your fields and bookings.
                    </CardDescription>
                </CardHeader>
                    ...
                    <Form {...form}>
                        ...
                        >
                            ...
                            <Button
                                ...
                                disabled={isPending}
                            >
                                {isPending ? "Creating Account..." : "Register as Venue Owner"}
                            </Button>
                        </form>
                    </Form>
                </CardContent>
                <div className="p-6 pt-0 flex flex-col items-center gap-2">
                    <span className="text-sm text-muted-foreground">
                     ...
                     <span className="text-xs text-muted-foreground">
                        Not a venue owner? <Link href="/register" className="text-primary hover:underline">Register as Player</Link>
                    </span>
