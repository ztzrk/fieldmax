...
import { CreateReportForm } from "@/app/reports/components/create-report-form";
...
export interface ReportsViewProps {
    title?: string;
    subtitle?: string;
    basePath?: string; // e.g. "/reports" or "/renter/reports"
}

export function ReportsView({
    title = "Help & Support",
    subtitle = "Track your reports or submit a new issue. We're here to help.",
    basePath = "/reports",
}: ReportsViewProps) {
                        ...
                        <div className="grid gap-4">
                            {filteredReports.map((report) => (
                                <Card
                                    ...
                                    onClick={() =>
                                        router.push(`${basePath}/${report.id}`)
                                    }
                                >
