...
const cities = [
    ...
    },
    {
        name: "Surabaya",
        province: "Jawa Timur",
        districts: ["Tegalsari", "Gubeng", "Wonokromo", "Sukolilo", "Rungkut"],
    },
    {
        name: "Bali",
        province: "Bali",
        districts: ["Canggu", "Seminyak", "Ubud", "Kuta", "Denpasar", "Sanur"],
    },
    {
        name: "Tangerang",
        province: "Banten",
        districts: ["BSD", "Gading Serpong", "Bintaro", "Ciputat", "Pamulang"],
    },
    {
        name: "Bogor",
        province: "Jawa Barat",
        districts: ["Sentul", "Puncak", "Cibinong", "Sukasari"],
    },
    {
        name: "Yogyakarta",
        province: "DIY",
    ...
    },
    {
        ...
        districts: ["Simpang Lima", "Tembalang", "Banyumanik"],
    },
    {
        name: "Makassar",
        province: "Sulawesi Selatan",
        districts: ["Panakkukang", "Losari", "Tamalanrea"],
    },
];
...
const reviewComments = [
    ...
    {
        text: "Lighting was a bit dim for the night game, but otherwise okay.",
        ratingDist: [3, 4],
    },
    {
        text: "Had a blast with my team here. Good facilities.",
        ratingDist: [5],
    },
    { text: "The parking situation was a nightmare.", ratingDist: [2, 3] },
    { text: "Staff was very friendly and helpful.", ratingDist: [4, 5] },
    {
        text: "Price is a bit high for the quality of the turf.",
        ratingDist: [3],
    },
    ...
    {
        text: "Synthetic turf is starting to wear out in some spots.",
        ratingDist: [3, 2],
    },
...
export async function seedVenues(prisma: PrismaClient) {
    ...
    try {
        ...
        // scheduleOverride deletion removed
    ...
    if (!renter) throw new Error("Renter not found! Run seed_users.ts first.");
    ...
    if (sportTypes.length === 0)
        throw new Error("No sport types found! Run seed_sport_types.ts first.");
    ...
    for (let i = 0; i < TOTAL_VENUES; i++) {
        ...
        const nameMiddle =
            Math.random() > 0.5 ? pickRandom(venueAdjectives) : district;
        ...
        const address = `Jl. ${district} Raya No. ${randomInt(
            1,
            200
        )}, ${district}`;
                ...
                schedules: {
                    create: [
                        ...
                        },
                        {
                            dayOfWeek: 5,
                            openTime: new Date("2024-01-01T08:00:00.000Z"),
                            closeTime: new Date("2024-01-01T23:00:00.000Z"),
                        },
                        {
                            dayOfWeek: 6,
                            openTime: new Date("2024-01-01T07:00:00.000Z"),
                            closeTime: new Date("2024-01-01T23:00:00.000Z"),
                        },
                        {
                            dayOfWeek: 0,
        ...
        if ((i + 1) % 10 === 0)
            console.log(`Created ${i + 1} / ${TOTAL_VENUES} venues...`);
    }

    console.log("Seeding venues finished successfully!");
}
