...
async function main() {
    ...
    for (let i = 0; i < 200; i++) {
        ...
        const fieldsData = Array.from({ length: numFields }).map((_, fIndex) => {
            ...
            return {
                ...
                pricePerHour: 50000 + (Math.floor(Math.random() * 10) * 10000), // Random price 50k-150k
        ...
        const venuePromise = prisma.venue.create({
            data: {
                ...
                schedules: {
                    create: [
                        { dayOfWeek: 0, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 1, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 2, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 3, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 4, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 5, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                        { dayOfWeek: 6, openTime: new Date("1970-01-01T08:00:00Z"), closeTime: new Date("1970-01-01T22:00:00Z") },
                    ]
                },
                fields: {
                    create: fieldsData
