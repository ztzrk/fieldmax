...
Tahap pengumpulan data dilakukan untuk mengidentifikasi kebutuhan bisnis, kendala operasional, dan parameter fungsional yang harus diakomodasi oleh sistem. Metode pengumpulan data yang diterapkan dalam penelitian ini adalah **Studi Literatur**.

Studi literatur dilakukan dengan menelaah berbagai sumber rujukan ilmiah tertulis, mencakup buku teks rekayasa perangkat lunak, jurnal ilmiah nasional dan internasional terakreditasi, serta dokumentasi teknis resmi (*official technical documentation*) terkait teknologi yang diimplementasikan (Next.js, Express.js, PostgreSQL, Prisma ORM, Midtrans API, dan ImageKit SDK). Informasi yang diperoleh menjadi landasan teoretis dan acuan penentuan arsitektur sistem reservasi lapangan multi-tenant.
...
Pada tahap ini, dilakukan elisitasi dan analisis mendalam untuk merumuskan spesifikasi kebutuhan fungsional dan non-fungsional sistem berdasarkan kendala proses bisnis reservasi manual.
...
Pada tahap ini, dilakukan pengujian perangkat lunak menggunakan metode *Black Box Testing*. Pengujian difokuskan pada validasi fungsionalitas seluruh fitur utama, meliputi registrasi/otentikasi, alur reservasi *real-time*, integrasi pembayaran otomatis Midtrans, manajemen venue/lapangan oleh Renter, serta moderasi oleh Admin.
...
Berdasarkan hasil studi literatur dan observasi proses bisnis konvensional pada penyedia sarana olahraga di Kota Makassar, dirumuskan 10 permasalahan utama yang menjadi justifikasi pengembangan platform FieldMax:
...
Diagram pada Gambar 9 menggambarkan pembagian 22 *use case* yang terdistribusi ke dalam tiga peran aktor: Admin, Renter, dan User.
